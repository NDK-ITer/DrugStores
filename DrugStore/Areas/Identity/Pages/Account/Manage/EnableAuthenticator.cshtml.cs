...
namespace DrugStore.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(7, ErrorMessage = "Độ dài ít nhất 6 ký tự.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Người dùng có ID '{UserId}' đã bật 2FA với ứng dụng xác thực.", userId);
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(AppNetUser user)
        {
